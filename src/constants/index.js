...
export const repoLink = "https://github.com/varunch29";

export const callToAction = "https://www.linkedin.com/in/varun-reddy-378a4a2a6/";
...
export const educationList = [
  {
    id: "education-1",
    icon: nitk,
    title: "CVR College of Engineering , Hyderabad",
...
export const projects = [
  {
    id: "project-1",
    title: "BE FIT",
    github: "https://github.com/varunch29",
    link: "https://comicify-ai.vercel.app/",
    image: comicify_ai,
    content:
      "Be Fit is a comprehensive fitness and wellness platform designed to help individuals achieve their health goals through personalized workout plans, diet recommendations, and real-time progress tracking.",
    stack: [
      {
        id: "icon-1",
        icon: SiReact,
  ...
  },
  {
    ...
    image: greentrust,
    content:
      "Doctor Appointment is an advanced online healthcare platform that allows patients to book medical consultations with doctors seamlessly.",
    stack: [
      {
        id: "icon-1",
        icon: SiReact,
...
export const socialMedia = [
  {
    id: "social-media-1",
    icon: AiFillLinkedin,
    link: "https://www.linkedin.com/in/varun-reddy-378a4a2a6/",
  },
  {
    id: "social-media-2",
    icon: AiFillGithub,
    link: "https://github.com/varunch29",
  },
  {
    id: "social-media-3",
    icon: AiFillMail,
    link: "varunreddynani29@gmail.com",
  },
  {
    id: "social-media-4",
    icon: AiOutlineTwitter,
    link: "https://x.com/varunreddy82601",
  },
  {
    id: "social-media-5",
    icon: AiFillInstagram,
    link: "https://www.instagram.com/varun_reddy_456",
  },
];
